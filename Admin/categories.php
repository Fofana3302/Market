      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
             <!-- Vertical Form -->
             <form class="row g-3" action="categoriesCode.php" method="POST">
              <div class="col-12">
                <label for="libCat" class="form-label">Libellé </label>
                <input type="text" class="form-control" name="libCat" id="idlibCat">
              </div>
